...
def create_RP_nonSimiliarity_trials(numTrials, numStim, otherStimNumber, dataFrame):
    ...
    for displays in range(1,3):
        ...
        for iter in range(rangeList[0], rangeList[1]):
            ...
            for i in range(otherStimNumber):
                ...
                for x in range(numStim - otherStimNumber * 2):
                    stimList.append(otherStim)
            ...
            dataFrame.iloc[iter,0] = "Display {} RP".format(displays)
...
# ======================================================================================================================
# create empty df
numTrials = 800 # co: 40 trials each session/ 200 trials each week/ 800 trials each month
RP_trials_3stim_nonSimiliar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RP_nonSimiliarity_trials(numTrials, 3, 1, RP_trials_3stim_nonSimiliar)
...
# create empty df
numTrials = 800
RP_trials_4stim_nonSimiliar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RP_nonSimiliarity_trials(numTrials, 4, 1, RP_trials_4stim_nonSimiliar)
...
# create empty df
numTrials = 800
RP_trials_5stim_nonSimiliar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RP_nonSimiliarity_trials(numTrials, 5, 2, RP_trials_5stim_nonSimiliar)
...
def create_RP_similiarity_trials(numTrials, numStim, otherStimNumber, dataFrame):
...
# create empty df
numTrials = 800
RP_trials_3stim_similiar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RP_similiarity_trials(numTrials, 3, 1, RP_trials_3stim_similiar)
...
# create empty df
numTrials = 800
RP_trials_4stim_similiar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RP_similiarity_trials(numTrials, 4, 1, RP_trials_4stim_similiar)
...
# create empty df
numTrials = 800
RP_trials_5stim_similiar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RP_similiarity_trials(numTrials, 5, 2, RP_trials_5stim_similiar)
