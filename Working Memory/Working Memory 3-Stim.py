...
for j in range(20):
    ...
    if start < 200:
        ...
        trials_easy.iloc[start, 0] = "Display 0.3".format(displays)
    else:
        trials_easy.iloc[start, 0] = "Display 0.4".format(displays)
...
for displays in range(1,5):
    ...
    for i in range(rangeList[0], rangeList[1]):
        ...
        # Assign Display variable
        trials_normal.iloc[i, 0] = "Display {} WM".format(displays)
        # Add first stim to real df
...
for j in range(20):
    ...
    if start < 200:
        ...
        trials_normal.iloc[start, 0] = "Display 0.3".format(displays)
    else:
        trials_normal.iloc[start, 0] = "Display 0.4".format(displays)
...
for displays in range(1,5):
    ...
    for i in range(rangeList[0], rangeList[1]):
        ...
        # Assign Display variable
        trials_hard.iloc[i, 0] = "Display {} WM".format(displays)
        # Add first stim to real df
        trials_hard.loc[i, fieldNumberList[0]] = trials_hard_preDF.loc[i, 0]
        # Save correct answer to real df
        trials_hard.loc[i, 36] = trials_hard_preDF.loc[i, 0]
...
for j in range(20):
    ...
    if start < 200:
        ...
        trials_hard.iloc[start, 0] = "Display 0.3".format(displays)
    else:
        trials_hard.iloc[start, 0] = "Display 0.4".format(displays)
