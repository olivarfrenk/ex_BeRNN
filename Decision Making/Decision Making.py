...
# todo: nonSimiliar
def createDMSheets_nonSimiliar(numTrials, dataframe, numStim):
    ...
    for displays in range(1, 3):
        ...
        for iter in range(rangeList[0], rangeList[1]):
            ...
            dataframe.iloc[iter, 0] = "Display {} DM".format(displays)
            ...
            dataframe.loc[iter, 36] = answerDict[stimList[-1].iloc[0, 0].split('_')[1].split('.')[0]]
...
# ======================================================================================================================
numTrials = 800
DM_trials_3stim_nonSimiliar = pd.DataFrame(index = range(800), columns = range(37))
numStim = 3
# create trials
createDMSheets_nonSimiliar(numTrials, DM_trials_3stim_nonSimiliar, numStim)

# ======================================================================================================================
# Create 800 trials for normal - 4stim nonSimiliar
# ======================================================================================================================
numTrials = 800
DM_trials_4stim_nonSimiliar = pd.DataFrame(index = range(800), columns = range(37))
numStim = 4
# create trials
createDMSheets_nonSimiliar(numTrials, DM_trials_4stim_nonSimiliar, numStim)

# ======================================================================================================================
# Create 800 trials for hard - 5stim nonSimiliar
# ======================================================================================================================
numTrials = 800
DM_trials_5stim_nonSimiliar = pd.DataFrame(index = range(800), columns = range(37))
numStim = 5
# create trials
createDMSheets_nonSimiliar(numTrials, DM_trials_5stim_nonSimiliar, numStim)



# todo: similiar
def createDMSheets_similiar(numTrials, dataframe, numStim):
    # Fill all rows for the first 100 and second 100 (for distributing reasons on the two circles in gorilla)
    for displays in range(1, 3):
        if displays == 1:
            rangeList = [0, int(numTrials/2)]
...
# ======================================================================================================================
numTrials = 800
DM_trials_3stim_similiar = pd.DataFrame(index = range(800), columns = range(37))
numStim = 3
# create trials
createDMSheets_similiar(numTrials, DM_trials_3stim_similiar, numStim)

# ======================================================================================================================
# Create 800 trials for normal - 4stim nonSimiliar
# ======================================================================================================================
numTrials = 800
DM_trials_4stim_similiar = pd.DataFrame(index = range(800), columns = range(37))
numStim = 4
# create trials
createDMSheets_similiar(numTrials, DM_trials_4stim_similiar, numStim)

# ======================================================================================================================
# Create 800 trials for hard - 5stim nonSimiliar
# ======================================================================================================================
numTrials = 800
DM_trials_5stim_similiar = pd.DataFrame(index = range(800), columns = range(37))
numStim = 5
# create trials
createDMSheets_similiar(numTrials, DM_trials_5stim_similiar, numStim)