...
def create_RPAnti_nonSimiliarity_trials(numTrials, numStim, otherStimNumber, dataFrame):
    ...
    for displays in range(1, 5):
        ...
        for iter in range(rangeList[0], rangeList[1]):
            ...
            # append the same stim again
            for x in range(numStim-(otherStimNumber+1)):
                stimList.append(firstStim)
            ...
            while stimFound == False:
                ...
                stimFound = color_nonSimiliarity(c1, c2, c3, f1, f2, f3, splitted_otherStim_color, splitted_otherStim_form, otherStim, stimList)
            for i in range(otherStimNumber-1):
                stimList.append(otherStim)
            ...
            dataFrame.iloc[iter,0] = "Display {} RP Anti".format(displays)
...
# create empty df
numTrials = 800
RP_Anti_trials_3stim_nonSimiliar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RPAnti_nonSimiliarity_trials(numTrials, 3, 1, RP_Anti_trials_3stim_nonSimiliar)
...
# create empty df
numTrials = 800
RP_Anti_trials_4stim_nonSimiliar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RPAnti_nonSimiliarity_trials(numTrials, 4, 1, RP_Anti_trials_4stim_nonSimiliar)
...
# create empty df
numTrials = 800
RP_Anti_trials_5stim_nonSimiliar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RPAnti_nonSimiliarity_trials(numTrials, 5, 2, RP_Anti_trials_5stim_nonSimiliar)


# co: Functions for similiarity ########################################################################################

def form_similiarity(form1, form2, form3, otherStim_form, otherStim, stimList):
    if otherStim_form == form1 or otherStim_form == form2 or otherStim_form == form3:
        # append
        stimList.append(otherStim)
        stimFound = True
        return stimFound
...
def color_similiarity(color1, color2, color3, form1, form2, form3, otherStim_color, otherStim_form, otherStim, stimList):
    if otherStim_color == color1 or otherStim_color == color2 or otherStim_color == color3:
        stimFound = form_similiarity(form1, form2, form3, otherStim_form, otherStim, stimList)
        return stimFound
    else:
        stimFound = False
        return stimFound

def create_RPAnti_similiarity_trials(numTrials, numStim, otherStimNumber, dataFrame):
    ...
    for displays in range(1, 5):
        ...
        for iter in range(rangeList[0], rangeList[1]):
            ...
            while stimFound == False:
                ...
                splitted_otherStim_form = otherStim.iloc[0, 0].split('_')[1].split('.')[0]
                # compare new sampled stim with firstStim
                if firstStim.iloc[0][0] != otherStim.iloc[0][0]:
                    stimFound = color_similiarity(c1, c2, c3, f1, f2, f3, splitted_otherStim_color, splitted_otherStim_form, otherStim, stimList)
            for i in range(otherStimNumber-1):
                stimList.append(otherStim)
...
# ======================================================================================================================
# Create 800 trials for 3stim_similiar
# ======================================================================================================================
# create empty df
numTrials = 800
RP_Anti_trials_3stim_similiar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RPAnti_similiarity_trials(numTrials, 3, 1, RP_Anti_trials_3stim_similiar)


# ======================================================================================================================
# Create 800 trials for 4stim_similiar
# ======================================================================================================================
# create empty df
numTrials = 800
RP_Anti_trials_4stim_similiar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RPAnti_similiarity_trials(numTrials, 4, 1, RP_Anti_trials_4stim_similiar)


# ======================================================================================================================
# Create 800 trials for 5stim_similiar
# ======================================================================================================================
# create empty df
numTrials = 800
RP_Anti_trials_5stim_similiar = pd.DataFrame(index=range(numTrials), columns=range(37))
# create trials
create_RPAnti_similiarity_trials(numTrials, 5, 2, RP_Anti_trials_5stim_similiar)