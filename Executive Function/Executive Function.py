...
trials_easy.to_excel('EF_trials_sameColor_sameDirect.xlsx')
...
trials_normal.columns = ['display', 'Field 1', 'Field 2', 'Field 3', 'Field 4', 'Field 5', 'Field 6', 'Field 7',
                     ...
                     'TrialRandomisation', 'CorrectAnswer']
# Save df as spreadsheet
trials_normal.to_excel('EF_trials_diffColor_sameDirect.xlsx')


# ======================================================================================================================
# Create 200 trials for hard - diff color, diff direction
# ======================================================================================================================
...
trials_hard.columns = ['display', 'Field 1', 'Field 2', 'Field 3', 'Field 4', 'Field 5', 'Field 6', 'Field 7',
                     ...
                     'TrialRandomisation', 'CorrectAnswer']
# Save df as spreadsheet
trials_hard.to_excel('EF_trials_diffColor_diffDirect.xlsx')


# ======================================================================================================================
# Create 200 trials for hard - rand color, rand direction
# ======================================================================================================================
color_dict_rand = {
    'green': ['red', 'green'],
    'red': ['red', 'green']
...
trials_rand = pd.DataFrame(index = range(800), columns = range(37))
...
for displays in range(1,3):
    ...
    for i in range(rangeList[0],rangeList[1]):
        ...
        if ratio[0] == 1:
            splitted_otherStim_color = color_dict_rand[splitted_centralStim_color]
            splitted_otherStim_direction = 'X'
            otherStim = splitted_otherStim_color[0] + '_' + splitted_otherStim_direction[0] + '.png'
        else:
            splitted_otherStim_color = random.sample(color_dict_rand[splitted_centralStim_color], 1)
            splitted_otherStim_direction = random.sample(direction_dict_rand[splitted_centralStim_direction], 1)
            otherStim = splitted_otherStim_color[0] + '_' + splitted_otherStim_direction[0] + '.png'

        # Assign empty fields on current trial
        trials_rand.loc[i] = '000_000.png'
        # Fill the cells for correct and wrong answers
        trials_rand.loc[i, w] = otherStim
        trials_rand.loc[i, x] = otherStim
        trials_rand.loc[i, y] = centralStim.iloc[0, 0]
        trials_rand.loc[i, z] = otherStim
        trials_rand.loc[i, a] = otherStim
        # Save correct answer to real df
        if splitted_centralStim_color == 'green' and splitted_otherStim_direction != 'X':
            trials_rand.loc[i, 36] = greenResp_dict[splitted_centralStim_direction]
        elif splitted_centralStim_color == 'red' and splitted_otherStim_direction != 'X':
            trials_rand.loc[i, 36] = redResp_dict[splitted_centralStim_direction]
        elif splitted_otherStim_direction == 'X':
            trials_rand.loc[i, 36] = 'noResponse'

        # Assign Display variable
        trials_rand.iloc[i,0] = "Display {}".format(dis)
        # Add random fixation cross time
        fixation_cross_time = random.sample([100, 200, 300, 400, 500], 1)
        trials_rand.iloc[i,33] = fixation_cross_time[0]
        # Add random after response time
        after_response_time = random.sample([600, 700, 800, 900, 1000], 1)
        trials_rand.iloc[i,34] = after_response_time[0]
        # Add Trial Randomization
        trials_rand.iloc[i,35] = 1

# Give columns the right names
trials_rand.columns = ['display', 'Field 1', 'Field 2', 'Field 3', 'Field 4', 'Field 5', 'Field 6', 'Field 7',
                     'Field 8', 'Field 9', \
                     'Field 10', 'Field 11', 'Field 12', 'Field 13', 'Field 14', 'Field 15', 'Field 16',
                     'Field 17', 'Field 18', 'Field 19', \
                     'Field 20', 'Field 21', 'Field 22', 'Field 23', 'Field 24', 'Field 25', 'Field 26',
                     ...
                     'TrialRandomisation', 'CorrectAnswer']
# Save df as spreadsheet
trials_rand.to_excel('EF_trials_randColor_randDirect.xlsx')
